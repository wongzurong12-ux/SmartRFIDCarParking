...
@Composable
fun AdminParkingScreen(navController: NavController) {
                    ...
                    Column(
                        ...
                        Image(
                            ...
                            modifier = Modifier
                                .size(100.dp)
                                .clickable {
                                    navController.navigate("addParking")
                                }
                        )
                    ...
                    Column(
                        ...
                        Image(
                            ...
                            modifier = Modifier
                                .size(100.dp)
                                .clickable {
                                    navController.navigate("searchParking")
                                }
                        )
                        Spacer(modifier = Modifier.height(8.dp))
                        Text(
                    ...
                    Column(
                        ...
                        Image(
                            ...
                            modifier = Modifier
                                .size(100.dp)
                                .clickable {
                                    navController.navigate("updateParking")
                                }
                        )
                        Spacer(modifier = Modifier.height(8.dp))
                        Text(
                    ...
                    Column(
                        ...
                        Image(
                            ...
                            modifier = Modifier
                                .size(100.dp)
                                .clickable {
                                    navController.navigate("deleteParking")
                                }
                        )
                        Spacer(modifier = Modifier.height(8.dp))
                        Text(
